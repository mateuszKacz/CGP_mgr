#
#   Experiment gathers data for the simulations with CGP + SA
#   algorithm
# ---------------------------------------- #
...
def main():
    ...
    MAIN_DATA_GATHER_PATH = pathlib.Path().absolute() / "src/data_gather/cgpsa"
    ...
    save_to_csv(
        ...
        / f"cgp_sa_pt_comparison_retries{retry}_num_sim_{num_sim}_steps_{steps}.csv",
    )
