...
def main():
    ...
    save_to_csv(all_data, MAIN_DATA_GATHER_PATH / f'pt_example_numsim{num_sim}_switch_steps1_50_steps{steps}_ptscheme{pt_scheme[0]}{pt_scheme[1]}_sa{annealing_scheme[0]}.csv')
